...
export const Inscription = () => {
  ...
  const handleRegister = async(e)=> {
    ...
    if (password !== passwordConfError || password.length <8 || !terms.checked) {
      ...
      if (!terms.checked) {
        termsError.innerHTML="Veuillez cocher les conditions d'utilisations"
      }
    } else {
      await axios({
        method:"post",
      ...
      <>
        {formSubmit ? (
          ...
          rounded-md border-black mx-12 my-4 md:mx-[20%] lg:mx-[20%]" onSubmit={handleRegister}>
            ...
            <label className='mx-8 my-2 md:mx-12' 
            htmlFor='terms'>J'accepte les termes et conditions</label>
